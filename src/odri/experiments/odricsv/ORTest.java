...
public class ORTest {
    ...
    public static ORLine applyCV(Instances train, ORLine story)
            throws Exception {

        ORLine result = ORLine.of(story.get(L2KEYS.dataset))
    ...
    public static List<String> oneGo(Instances data, ORLine basiceStory, double median) {
    ...
    public static List<String> oneTest(String dataset)
        ...
        ORLine basicStory = ORLine.of(dataset);
