 ...
 */
public class EarlyOptions implements OptionHandler, Serializable {

  static final long serialVersionUID = 1310258885025902127L;
  static Logger logger = LoggerFactory.getLogger(EarlyOptions.class);
  ...
  protected String m_algorithm = "early";
  ...
  public static void changeLogLevelRunTime(String logLevel) {
    ((ch.qos.logback.classic.Logger) LoggerFactory.getLogger(Early.class)).setLevel(Level.toLevel(logLevel));
