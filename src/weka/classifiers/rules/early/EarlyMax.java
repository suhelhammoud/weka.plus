...
public class EarlyMax {
  ...
  private EarlyMax(int minFreq, double minConfidence) {
    this.minFreq = minFreq;
    this.minConfidence = minConfidence;
  }

  public EarlyMax copy() {
    EarlyMax result = new EarlyMax(this.minFreq, this.minConfidence);
   ...
   */
  public static EarlyMax of(int[][][] count) {
    EarlyMax mi = new EarlyMax(0, 0);
   ...
   */
  public static EarlyMax ofThreshold(int[][][] count,
                                     int minFreq,
                                     double minConfidence) {
    EarlyMax mi = new EarlyMax(minFreq, minConfidence);
    for (int at = 0; at < count.length; at++) {
      for (int itm = 0; itm < count[at].length; itm++) {
   ...
   */
  private EarlyMax maxWithThreshold(int[] itemLabels,
                                    int attIndex,
                                    int itemIndex) {
  ...
  public static EarlyMax ofOne(int[][][] count, int label) {
    EarlyMax mi = new EarlyMax(0, 0);
    for (int at = 0; at < count.length; at++) {
      for (int itm = 0; itm < count[at].length; itm++) {
