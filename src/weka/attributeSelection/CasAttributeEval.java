...
public class CasAttributeEval extends ASEvaluation implements
        AttributeEvaluator, OptionHandler {

  static Logger logger = LoggerFactory.getLogger(CasAttributeEval.class.getName());
...
//                logger.info("run att eval with algorithm items = {}", items.size());
  ...
  public static void main(String[] args) {
    runEvaluator(new CasAttributeEval(), args);
