...
public class PasOptions2 implements OptionHandler, Serializable {
  ...
  public PasMethod2 getPasMethodEnum() {
    return PasMethod2.of(m_pasMethod);
  }


  public SelectedTag getPashMethod() {
    return PasMethod2.of(m_pasMethod).selectedTag();
  }
