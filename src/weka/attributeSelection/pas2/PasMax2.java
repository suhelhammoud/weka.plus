...
public class PasMax2 {
  ...
  private PasMax2(int minFreq, double minConfidence) {
    this.minFreq = minFreq;
    this.minConfidence = minConfidence;
  }

  public PasMax2 copy() {
    PasMax2 result = new PasMax2(this.minFreq, this.minConfidence);
   ...
   */
  public static PasMax2 of(int[][][] count) {
    PasMax2 mi = new PasMax2(0, 0);
   ...
   */
  public static PasMax2 ofThreshold(int[][][] count,
                                    int minFreq,
                                    double minConfidence) {
    PasMax2 mi = new PasMax2(minFreq, minConfidence);
    for (int at = 0; at < count.length; at++) {
      for (int itm = 0; itm < count[at].length; itm++) {
   ...
   */
  private PasMax2 maxWithThreshold(int[] itemLabels,
                                   int attIndex,
                                   int itemIndex) {
  ...
  public static PasMax2 ofOne(int[][][] count, int label) {
    PasMax2 mi = new PasMax2(0, 0);
    for (int at = 0; at < count.length; at++) {
      for (int itm = 0; itm < count[at].length; itm++) {
