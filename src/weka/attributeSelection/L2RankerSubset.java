 ...
 * <br/>
 * Ranks attributes by their individual evaluations, apply frequency threshold. Use in conjunction with
 * attribute evaluators (ReliefF, GainRatio, ChiSquare, L2, etc).<br/>
 * <p/>
 * <!-- globalinfo-end -->
 * <p>
 ...
 *  Specify a frequency theshold by which attributes
 ...
 */
public class L2RankerSubset extends Ranker {
  //TODO change base class, re-implement to get rid of unwanted inhereted parameters which come with Ranker
  /**
   * for serialization
   */
  static final long serialVersionUID = -9186754847510751934L;
...
//        m_numToSelect = n;
  ...
  private static double frequencyThreshold(double[] values, double ratio) {
    if (ratio < 1.0E-14) return 0;
    //TODO ratio = 1, this solution takes at least one attribute, check if needs to change it
...
//    System.out.println("ratio = " + ratio);
  ...
  public String toString() {
    StringBuilder result = new StringBuilder();
    result.append("\tAttribute ranking.\n");

    if (m_starting != null) {
      result.append("\tIgnored attributes: ");
